...
fn print_admin() {
    let admin_pass = get_input("Enter admin password:");
    // so secure!!! :D
...
fn print_pm() {
    ...
    let mut file = std::fs::File::open("projects_table.sql").unwrap();
    let mut contents = String::new();
    file.read_to_string(&mut contents).unwrap();
    println!("{}", contents);
}
...
fn print_customer() {
    ...
    let mut file = std::fs::File::open("customers_table.sql").unwrap();
    let mut contents = String::new();
    file.read_to_string(&mut contents).unwrap();
    println!("{}", contents);
}
...
fn print_vendor() {
    ...
    let mut file = std::fs::File::open("data_plan_table.sql").unwrap();
    let mut contents = String::new();
    file.read_to_string(&mut contents).unwrap();
    println!("{}", contents);
}
