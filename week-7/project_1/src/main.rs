...
fn main() {
    let calc_type = read_line(
        "
Choose a type of calculator (Enter Code):
    T: Area of Trapezium
    R: Area of Rhombus
...
fn area_trapezium() {
    ...
    let height: f32 = read_line("Enter height:")
        .parse()
        .expect("height should be a number");
    let base1: f32 = read_line("Enter base1:")
        .parse()
        .expect("base1 should be a number");
    let base2: f32 = read_line("Enter base2:")
        .parse()
        .expect("base2 should be a number");
...
fn area_rhombus() {
    ...
    let diagonal1: f32 = read_line("Enter diagonal1:")
        .parse()
        .expect("diagonal1 should be a number");
    let diagonal2: f32 = read_line("Enter diagonal2:")
        .parse()
        .expect("diagonal2 should be a number");
...
fn area_parallelogram() {
    ...
    let base: f32 = read_line("Enter base:")
        .parse()
        .expect("base should be a number");
    let altitude: f32 = read_line("Enter altitude:")
        .parse()
        .expect("altitude should be a number");
...
fn area_cube() {
    ...
    let length: f32 = read_line("Enter length of side:")
        .parse()
        .expect("length of side should be a number");
...
fn volume_cylinder() {
    ...
    let radius: f32 = read_line("Enter radius:")
        .parse()
        .expect("radius should be a number");
    let height: f32 = read_line("Enter height:")
        .parse()
        .expect("height should be a number");
